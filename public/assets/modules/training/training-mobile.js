...
var startApp = function () {
    ...
    $(document).ready(function () {
        ...
        $('.btn-text-filter').click(function(){
            $('.div-filter').slideToggle('slow');
            if(!$(this).hasClass("filter-showed")){
                $(this).addClass("filter-showed");
                $(this).text('Đóng bộ lọc');
            }else{
                $(this).removeClass("filter-showed");
                $(this).text('Bộ lọc');
            }
        });
        ...
        $('.btn-register').click(function(){
            ...
            register = $(this).parents(".bl-content-training").first().data('item');
        });
        ...
        $('.btn-finish').click(function(){
            ...
            if(userInfo == null){
                ...
                $("#check-phone .send-check-phone").unbind("click").click(function () {
                    ...
                    if(checkResult){
                        var dataCheckPhone = {phone:checkResult.phone};
