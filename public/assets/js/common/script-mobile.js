...
var BJLL_options = BJLL_options || {},
    BJLL = {
        ...
        show: function (e) {
            ...
            if ("image" == t)
                null != e.getAttribute("data-lazy-srcset") && e.setAttribute("srcset", e.getAttribute("data-lazy-srcset")), null != e.getAttribute("data-lazy-sizes") && e.setAttribute("sizes", e.getAttribute("data-lazy-sizes")), e.setAttribute("src", e.getAttribute("data-lazy-src"));
...
$(document).ready(function () {
    if($('.banner-home .btn-search').length>0){
        $('#header .isearch').hide();
    }

    $(".toggleClass > .toggle").click(function () {
        $(this).parent().toggleClass('active');
    });
//    $(".btn-search-common").click(function () {
//        $('body').toggleClass('showModalSearch');
//    });
    ...
    function loadPWA(){}
    // loadJS('/assets/js/pwa-mobile.js', loadPWA, document.body);
// end
});