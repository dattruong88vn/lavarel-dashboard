...
if(isset($_POST) && count($_POST)) {
	$x = $_POST['xvalue'];
	$y = $_POST['yvalue'];
	$r = exec('echo "'.$y.' '.$x.'" | /usr/bin/cs2cs +proj=tmerc +lat_0=0 +lon_0=105.75 +k=0.9999 +x_0=500000 +y_0=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +to +proj=longlat +datum=WGS84 +no_defs -f %.10f', $resultInput);
