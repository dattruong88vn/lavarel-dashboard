    ...
    <div class="box box-primary">
        <div class="box-body">
            <ul style="margin-bottom: 10px;" class="nav nav-tabs">
              <li class="{{ !isset($_GET['listingTypeId']) ? 'active' : '' }}"><a href="/new-listing-match-lead">Mua</a></li>
              <li class="{{ isset($_GET['listingTypeId']) ? 'active' : '' }}"><a href="/new-listing-match-lead?listingTypeId=2">Thuê</a></li>
            </ul>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div>&nbsp;</div>
                    <button class="btn btn-warning btnFilterListingLead">Tìm</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="current-lead-id" value="" />
                <table class="table table-bordered tableChooseListings">
                    <thead>
                        <tr>                        
                            <th>Chọn</th>
                            <th>ID</th>
...
<script src="{{ loadAsset("/js/new-listing-match-lead/index.js")}}"></script>
@stop
...
<style>
    ...
    .table-leads .leads td{
        background: #7bbe0b !important;
    }
    .table-leads .leads td .customer span{
    ...
    .first-child td a , .table-leads .leads td a{
        color: #fff;
    }
    .s-good td{
        background: #faa;
