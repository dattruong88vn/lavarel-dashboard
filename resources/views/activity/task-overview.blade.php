    ...
    <section class="box">
        ...
        <div class="box-body">
            <div class="col-sm-3">
                <ul class="list">
                        <li>
                            <label><input type="checkbox" class="task-type task-type-all" value="-1" /> tất cả</label>
                        </li>
                    <?php foreach ($typeList as $type): ?>
                        <li>
                            <label><input type="checkbox" class="task-type" value="{{$type->typeId}}" /> {{$type->typeName}}</label>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
