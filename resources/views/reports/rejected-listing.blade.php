		        ...
		        <div class="col-md-12">                
					<div class="box box-primary">
						<div class="box-header with-border">
						  	<h3 class="box-title">REJECTED LISTINGS</h3>
						...
						<div class="box-body">
							...
							<table id="rejected-list" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th>RID</th>
										<th>Ngày giao</th>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
	  $("#rejected-list").DataTable({
	  	...
	  	"processing": true,
        "serverSide": true,
        "ajax": "/report/get-rejected-count/<?=$queryString?>",
        "columns": [
	        	{ data: 'rlistingId' },
	  ...
	  $(".btn-export").click(function(){
	  		showPropzyLoading();
	    	$.post("/report/export-report/listing-count-reject", <?=$postData?>, function(response){
	    		if(response.result) {
