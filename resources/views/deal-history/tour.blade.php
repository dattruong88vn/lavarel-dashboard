  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#tab_1-1" data-toggle="tab">Số tour booked <span class="badge">{{$countHistories->numberOfTours}}</span></a></li>
        <li ><a href="#tab_2-2" data-toggle="tab">Số tour đã đi <span class="badge">{{$countHistories->numberOfWentTours}}</span></a></li>
      ...
      <div class="tab-content">
        <div class="tab-pane active customDatatable" id="tab_1-1">
          <table id="tourBookedHistories"  class="table-striped-custom table table-striped table-striped-custom-fix-filter">
              <thead>
                  <tr>
                      <th >Ngày - Giờ đi</th>
                  ...
                  <tr><th></th><th></th><th></th><th>
                    <select placeholder="Lọc theo trạng thái" style="width:100%" class="statusBookFilter">
                      <option value="0">Tất cả</option>
                      <option value="1">Sẽ đi</option><option value="2">Đã đi</option><option value="3">Hủy</option>
                    </select>
                  </th><th></th></tr>
              </thead>
        ...
        <div class="tab-pane customDatatable" id="tab_2-2">
...
<script type="text/javascript">
  ...
  function loadTableTourCancledHistory(url = "/deal-history/list-tour-cancled/{{$deal->dealId}}"){
  ...
  function loadTableTourGone(){
    $("#tourGone").DataTable({
        "responsive": true,
        "processing": true,
        "searching": false,
        "serverSide": true,
        "ajax": '/deal-history/list-tour-gone/{{$deal->dealId}}',
        "scrollX": false,
        "lengthChange": false,
  ...
  function loadTableTourBookedHistory(url = "/deal-history/list-tour-booked/{{$deal->dealId}}"){
        ...
        initComplete: function(settings, json) {
            ...
            //   } );
              ...
              $('.statusBookFilter').change(function(){
                ...
                loadTableTourBookedHistory('/deal-history/list-tour-booked/{{$deal->dealId}}?statusBook='+$(this).val());
              })
          }   
    });
  }
  ...
  var poinRender = function (data, type, object) {
      var poinRenderTourGone = "";
      var listings = object.listings;
      $.each(listings,function(key,value){
        if(value.reasonValue == null){
          var render = "";
          var poin = value.percentValue;
          switch(true) {
              case (poin <= 20):
          ...
          poinRenderTourGone += "<div class='datatableChildCustom starRenderPropzy' poin='"+value.percentValue+"'>"+render + "</div>";
        }else{
          poinRenderTourGone += "<div class='datatableChildCustom'>"+value.reasonValue + "</div>";
        }
        
      })
      return poinRenderTourGone;
  }
  ...
  var csReviewRender = function (data, type, object) {
      ...
      var listings = object.listings;
      $.each(listings,function(key,value){
        var result = value.csFeedbackForListing;
        if(result == null){result = "N/A"};
        review += "<div class='datatableChildCustom'>"+ result + "</div>";
      })
      return review;
  }
  ...
  $(document).ready(function() {
      ...
      $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
          $($.fn.dataTable.tables(true)).DataTable()
            ...
            }else if(target == '#tab_2-2'){
              $("#tourGone").dataTable().fnDestroy();
              loadTableTourGone();
