<div id="create-reminder-modal" class="modal" role="dialog" aria-hidden="false">
			...
			<div class="modal-body message">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<textarea name="" id="reminder-note" cols="30" rows="10" class="form-control editor"></textarea>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button id="sa-create-reminder" type="button" class="btn btn-success">Lưu</button>
			</div>
		</div>
	</div>
</div>