                    ...
                    <div class="box-body">
                        ...
                        <div class="row source-group form-group sa-btn-action-top">
                            <div class="col-md-12 text-right">
                                <a id="show-log-active" href="/logs-active/index/{{$detailData->id}}?typeLRListing=PRE" target="_blank" class="btn btn-success btn-sm">Lịch sử</a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 text-right">
                                <a href="#" id="showHisCall" data-entitytype="PRESCREEN" data-entityid="{{$detailData->id}}" class="btn btn-success">Lịch sử cuộc gọi</a>
                                <div style="display:inline-block" id="tasks-of-comments"></div>
                            </div>
                        </div>
                        <!-- BEGIN LINK -->
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-4"  id="error-propertyTypeId-wrapper"></div>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-12">
                                <div id="blc-project-land" style="display: none;">
                                    <label class="control-label col-xs-12 col-sm-2 col-md-2 label-projectId">Dự án</label>
                                        <div class="select-2 col-xs-12 col-sm-10 col-md-3"><select id="projectId" class="form-control"></select>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="display-use-diy-group">
                            <div class="row form-group ">
                                <div class="col-sm-12">
                                    <label class="control-label col-xs-12 col-sm-2 col-md-2 label-useDiy">Sử dụng Propzy App/Web</label>
                                    <div class="col-xs-12 col-sm-10 col-md-5 display-unlock-btn"></div>
                                    <div class="col-xs-12 col-sm-10 col-md-5 display-unlock-message"></div>
                                    <div class="col-xs-12 col-sm-10 col-md-3 display-use-diy-btn"></div>
                                    <div class="col-xs-12 col-sm-10 col-md-2 display-use-diy-checkbox"></div>
                                    <div class="col-xs-12 col-sm-10 col-md-4 display-use-diy-message"></div>
                                </div>
                            </div>
                            <div class="row form-group display-not-use-diy"></div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-10 col-md-10">
                                    <div style="border: 1px solid #ccc">
                                        ...
                                        <div style="float:right; text-align:right; width: 19%;">
                                            <button type="button" style="margin:2px 2px 0px 0px;" class="btn btn-sm btn-primary class-view" id="virtual-touring-preview">Xem thử</button>
                                        </div>
...
<div id="photo-list-preview-modal" class="modal" role="dialog" aria-hidden="false">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-body">
                <img class="photo-list-preview-image" src="" alt="" style="max-width: 100%;max-height: 90vh;">
            </div>
        </div>
    </div>
</div>
...
@include('pos.prescreener.blocks.blc-cancel-listing-model')
...
<script src="{{ loadAsset("js/pos/prescreener/detail/CancelListing.js") }}"></script>
<script src="{{ loadAsset("js/pos/prescreener/detail/Call.js") }}"></script>
<script src="{{ loadAsset("js/pos/prescreener/Fields.js") }}"></script>
<script src="{{ loadAsset("js/pos/prescreener/detail/ListingDetail.js") }}"></script>
<script src="{{ loadAsset("js/pos/prescreener/detail/ListingDetailJS.js") }}"></script>

<script src="{{loadAsset("/app/tasks_of_comments.js")}}"></script>
