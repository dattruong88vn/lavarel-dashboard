...
<div id="newMeetingReminderModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form id="formMakeMeetingReminderModal" method="post" >
                ...
                <input type="hidden" name="rlistingId" class="rlistingId" value="" />
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success btnSaveMeetingReminder">Save</button>
