...
<div style="padding: 0 50px; margin: 30px auto;">
    <div>
        ...
        <p>{{$currentUser->name}} đến từ công ty Propzy Việt Nam. Hiện trên Propzy.vn có một số <span class="propertyType">{{$leadDeal->propertyType->typeName}}</span> đúng với nhu cầu tìm kiếm của anh/chị. Vui lòng bấm vào link để xem chi tiết nhé:</p>
