        ...
        <div class="box box-primary">
            <div class="box-body">
                <?php if (!empty($task->listings)) : ?>
                    ...
                    <div class="row deal-tour" style="padding:15px 0">
                        <div class="col-sm-2 control-label">
                            Tên CS
                        </div>
                        <div class="col-sm-4 control-label">
                    ...
                    <table class="table table-bordered listingDetailTours" id="datatables">
                        <thead>
                            <tr>
                                <th>LID</th>
                                <th>Địa chỉ</th>
...
@include('crm-dashboard.modal-crm-update-deal-status')
...
$(".btnDoneTask").on("click", function (event) {
    var listingIds = [];
    $('.listingDetailTours').find('input[name="rlistingIds[]"]').each(function () {
