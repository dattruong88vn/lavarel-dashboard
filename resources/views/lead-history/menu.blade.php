      ...
      <div class="box-body">
        <a class="btn btn-app 
          @if(Request::segment(2) == 'requests')
            active
          @endif
        " href="/lead-history/requests/{{Request::segment(3)}}">
          <i class="fa fa-inbox"></i> Nhu Cầu
        </a>
        <!-- <a class="btn btn-app 
          @if(Request::segment(2) == 'tour')
            active
          @endif" href="/lead-history/tour/{{Request::segment(3)}}">
          <i class="fa fa-map-marker"></i> Tour
        </a> -->
        <a class="btn btn-app 
          @if(Request::segment(2) == 'call')
            active
          @endif" href="/lead-history/call/{{Request::segment(3)}}">
          <i class="fa fa-phone"></i> Call
        </a>
        <a class="btn btn-app 
          @if(Request::segment(2) == 'email')
            active
          @endif" href="/lead-history/email/{{Request::segment(3)}}">
          <i class="fa fa-envelope-o"></i> Email
        </a>
        <a class="btn btn-app 
          @if(Request::segment(2) == 'detail')
            active
          @endif" href="/lead-history/detail/{{Request::segment(3)}}">
