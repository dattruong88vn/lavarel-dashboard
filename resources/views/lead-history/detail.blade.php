...
<script type="text/javascript">
  ...
  function loadTableDetailHistories(url = '/lead-history/list-histories-detail/{{$lead->leadId}}'){
            ...
            //   // FILTER STATUS
              $('.filterEvent').change(function(){
                ...
                if($(this).val() != null && $(this).val().length > 0){
                  // console.log()
                  loadTableDetailHistories('/lead-history/list-histories-detail/{{$lead->leadId}}?historyTypeId='+$(this).val().join());
                }else{
                  loadTableDetailHistories();
                }
              })
