...
<div class='dashboard'>
    ...
    <section class="lead-chat">
        <div class="box box-primary direct-chat-success">
            <div class="box-header with-border">
                <h3 class="box-title">CHAT</h3>
            </div>
            <div class="box-body">
                <div class="text-center">
                    <button class="btn btn-success btn-switch-chat-source margin active" data-chat-source="lead">CHAT - DEAL</button>
                    <?php if (!empty($lead->orderId)): ?>
                        <button class="btn btn-success btn-switch-chat-source" data-chat-source="order">CHAT - ORDER</button>
                    <?php endif; ?>
                </div>
                <hr>
                <div class="bl-chat row">
                    <div class="col-sm-12">
                        <ul class="notesList">
                        </ul>
                    </div>
                ...
                <div class="box-footer">
                    <div class="input-group">
                        <input class="txtComment form-control" rows="8"></input>
                        <span class="input-group-btn">
                            <button type="button" id="btnSaveComment" class="btn btn-success btn-flat">Gửi</button>
                        </span>
                    </div>
                </div>
            </div>
...
<script src="{{loadAsset("/js/lead/chat.js")}}"></script>
