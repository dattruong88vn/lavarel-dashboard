...
//*** DEV DASHBOARD:
//api: ip-privite: 10.158.14.20                             ip-public: 45.117.162.60
//upload - ip:  45.117.162.49
//
//*** Staging:
//api: ip-privite:10.158.14.19                             ip-public: 45.117.162.50
//upload - ip: 45.117.162.50
//getUpload - ip:
//
//*** Master:
//api: ip-privite: như cũ                             ip-public: 45.117.162.44
//upload - ip: cdn.propzy.vn
//getUpload - ip:
// Nếu PHP upload qua API th2i gọi private 

// còn dùng javascript thì thì phải public

// Duy, 10:23 AM
// http://45.117.162.50:8080/file/api/upload (Là public)
// http://10.158.14.19:8080/file/api/upload (Là private)

//check null and setdefault
$_SERVER['SERVER_PORT'] = $_SERVER['SERVER_PORT'] ?? '';
$_SERVER['SERVER_ADDR'] = $_SERVER['SERVER_ADDR'] ?? '';
$_SERVER['SERVER_NAME'] = $_SERVER['SERVER_NAME'] ?? '';

if (!defined('BASE_API')) {
    define("BASE_LOCATION", "http://10.158.15.10:9096/v1/service-location/"); // IP private
    // define("BASE_LOCATION", "http://45.117.162.62:9096/v1/service-location/"); // IP public
    if (strpos($_SERVER['SERVER_PORT'], "8787") > -1) {
        ...
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.49:8080/file/api/'); // upload image
    ...
    } else if (strpos($_SERVER['SERVER_ADDR'], "10.158.14.34") > -1 && strpos($_SERVER['SERVER_PORT'], "8086") > -1 || strpos($_SERVER['SERVER_ADDR'], "10.158.14.34") > -1 && strpos($_SERVER['SERVER_PORT'], "8888") > -1) {
        // 45.117.162.49 laravel dev trên con .34 nhưng service chạy trên con .20 (public 60)
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.49:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.18:7777/');
        define('BASE_API', 'http://10.158.14.43:8086/dashboard/api/'); // server develop
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.20:9097/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.60:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.20:8082/propzy/api/');
        define('BASE_SAM_DB_API', 'http://45.117.162.60:8080/sam-dashboard/api/');
        define('BASE_WEB_SOCKET_API', 'http://45.117.162.39:8086/dashboard/api/'); // server develop
        define('FILE_UPLOAD_API', 'http://45.117.162.49:8080/file/api/');
        define('BASE_UPLOAD_API', 'http://10.158.14.19:8080/file/api/'); // upload image
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.50:8080/file/api/'); // upload image
        define('UPLOAD_PATH', __DIR__ . '/../public/media_test/');
        define('PRODUCT_URL', 'http://10.158.14.20/');
    ...
    } else if (strpos($_SERVER['SERVER_PORT'], "8888") > -1) {
        //config for crawler
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.49:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.1.5.190:7777/');
        define('BASE_API', 'http://10.1.4.88:8086/dashboard/api/'); // api crawler
        define('BASE_API_SEARCH_LISTING', 'http://10.1.6.84:8092/api/');
        define('BASE_API_EXPORT', 'http://10.1.4.88:8086/dashboard/api/');
        define('BASE_SAM_API', 'http://10.1.4.88:8081/propzy/api/'); // http://45.117.162.60:8082/propzy/api/
        define('BASE_SAM_DB_API', 'http://45.117.162.60:8080/sam-dashboard/api/');
        define('BASE_WEB_SOCKET_API', 'http://45.117.162.60:8080/dashboard/api/'); // server develop
        define('FILE_UPLOAD_API', 'http://10.1.5.190:8097/file/api/');
        define('BASE_UPLOAD_API', 'http://10.1.5.190:8097/file/api/'); // upload image
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.49:8080/file/api/'); // upload image
        define('UPLOAD_PATH', __DIR__ . '/../public/media_test/');
        define('PRODUCT_URL', 'http://10.158.14.20/');
        define('SITE_URL', 'http://10.158.14.20:8888/');
        ...
        define('AGENT_SITE_URL', 'http://dev.propzy.vn/');
        define('CRAWLER_API', 'http://10.158.14.34:8060/v1/');
    } else if (strpos($_SERVER['SERVER_ADDR'], "10.158.14.34") > -1 && strpos($_SERVER['SERVER_PORT'], "8989") > -1) {
        //config for crawler
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.49:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.18:7777/');
        define('BASE_API', 'http://10.158.14.20:8086/dashboard/api/'); // api crawler
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.20:9097/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.20:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.20:8082/propzy/api/'); // http://45.117.162.60:8082/propzy/api/
        define('BASE_SAM_DB_API', 'http://45.117.162.60:8080/sam-dashboard/api/');
        define('BASE_WEB_SOCKET_API', 'http://45.117.162.60:8080/dashboard/api/'); // server develop
        define('FILE_UPLOAD_API', 'http://10.158.14.34:8080/file/api/');
        define('BASE_UPLOAD_API', 'http://10.158.14.34:8080/file/api/'); // upload image
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.49:8080/file/api/'); // upload image
        define('UPLOAD_PATH', __DIR__ . '/../public/media_test/');
        define('PRODUCT_URL', 'http://10.158.14.20/');
        define('SITE_URL', 'http://10.158.14.20:8888/');
        ...
        define('AGENT_SITE_URL', 'http://dev.propzy.vn/');
        define('CRAWLER_API', 'http://10.158.14.34:8060/v1/');
    } else if (strpos($_SERVER['SERVER_ADDR'], "10.158.14.19") > -1 && strpos($_SERVER['SERVER_PORT'], "8888") > -1) {
        ...
        define('BASE_API', 'http://10.158.14.43:8080/dashboard/api/');
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.43:9097/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.39:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.43:8080/sam/api/');
        define('BASE_SAM_DB_API', 'http://10.158.14.43:8080/sam-dashboard/api/');
        define('BASE_WEB_SOCKET_API', 'http://10.158.14.43:8080/dashboard/api/');
        define('BASE_UPLOAD_API', 'http://10.158.14.19:8080/file/api/');
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.50:8080/file/api/');
        define('FILE_UPLOAD_API', 'http://10.158.14.19:8080/file/api/');
        define('UPLOAD_PATH', __DIR__ . '/../public/media_test/');
        ...
        define('CRAWLER_API', 'http://10.158.14.19:8060/v1/');
    } else if (strpos($_SERVER['SERVER_ADDR'], "10.158.14.19") > -1 && strpos($_SERVER['SERVER_PORT'], "8989") > -1) {
        // chạy trên con server 45.117.162.50 -> staging for crawler
        // php run on 50, service run on 39
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.50:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.19:7777/');
        define('BASE_API', 'http://10.158.14.43:8082/dashboard/api/');
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.43:9097/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.39:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.43:8080/sam/api/');
        define('BASE_SAM_DB_API', 'http://10.158.14.43:8080/sam-dashboard/api/');
        ...
        define('AGENT_SITE_URL', 'https://test.propzy.vn/');
        define('CRAWLER_API', 'http://10.158.14.19:8060/v1/');
    } else if (strpos($_SERVER['SERVER_ADDR'], "10.158.14.19") > -1 && strpos($_SERVER['SERVER_PORT'], "9191") > -1) {
        // chạy trên con server 45.117.162.50 -> staging for crawler
        // php run on 50, service run on 39
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.50:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.19:7777/');
        define('BASE_API', 'http://10.158.14.43:8085/dashboard/api/');
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.43:9097/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.39:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.43:8080/sam/api/');
        define('BASE_SAM_DB_API', 'http://10.158.14.43:8080/sam-dashboard/api/');
        ...
        define('BASE_API', 'http://45.117.162.49:8082/dashboard/api/');
        define('BASE_API_SEARCH_LISTING', 'http://45.117.162.60:9097/api/');
        //  define('BASE_API', 'http://45.117.162.49:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://45.117.162.60:8082/propzy/api/');
        define('BASE_WEB_SOCKET_API', 'http://45.117.162.49:8082/dashboard/api/');
        ...
        //		-----------------------------------------
    } else if (strpos($_SERVER['SERVER_NAME'], "171.244.45.168") > -1 && strpos($_SERVER['SERVER_PORT'], "8888") > -1) { //kyc training http://171.244.45.168:8888/
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.50:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.19:7777/');
        define('BASE_API', 'http://10.158.14.49:8082/dashboard/api/');
        define('BASE_API_EXPORT', 'http://45.117.162.39:8080/dashboard/api/');
        define('BASE_SAM_API', 'http://10.158.14.63:8080/sam/api/');
        define('BASE_SAM_DB_API', 'http://45.117.162.39:8080/sam-dashboard/api/');
        define('BASE_WEB_SOCKET_API', 'http://10.158.14.49:8082/dashboard/api/');
        define('BASE_UPLOAD_API', 'http://45.117.162.50:8080/file/api/');
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.50:8080/file/api/'); // upload image
        define('FILE_UPLOAD_API', 'http://10.158.14.19:8080/file/api/');
        define('UPLOAD_PATH', __DIR__ . '/../public/media_test/');
        ...
        define('AGENT_SITE_URL', 'https://test.propzy.vn/');
        define('CRAWLER_API', 'http://10.158.14.34:8060/v1/');
    } else if (strpos($_SERVER['SERVER_PORT'], "9999") > -1) { // master project
        define('GG_KEY', 'AIzaSyD2mFGqxpEhKmZ7ZmwD4lzePXLiCtMqBYE');
        define('UPLOAD_URL', 'http://45.117.162.49:7777/');
        define('UPLOAD_URL_PRIVATE', 'http://10.158.14.18:7777/');
        ...
        define('BASE_UPLOAD_API', 'http://cdn.propzy.vn:9090/file/api/'); // upload image
        define('BASE_UPLOAD_API_PUBLIC', 'http://45.117.162.50:8080/file/api/'); // upload image
        define('UPLOAD_PATH', '/var/www/html/media/');
        define('PRODUCT_URL', 'http://10.158.14.20/');
        define('SITE_URL', 'http://10.158.14.20:8888/');
        ...
        define('BASE_API_SEARCH_LISTING', 'http://10.158.14.46:9095/api/');

        define('BASE_WEB_SOCKET_API', 'https://dashboardws.propzy.vn/dashboard/api/');
        // upload image
        define('BASE_UPLOAD_API', 'https://cdn.propzy.vn:8443/file/api/');
        define('BASE_UPLOAD_API_PUBLIC', 'https://cdn.propzy.vn:8443/file/api/');
    ...
    define('LISTING_CUSTOM_SEARCH_VERSION_MATCHING', 'listing/filter-data');
    define('LISTING_LOG', 'listing/log');

    //note
    //{isPagination}/{numberItemOnePage}/{pageNumber}?
    //isPagination = false
    ...
    define('GET_LEAD_DETAIL', 'lead/detail');
