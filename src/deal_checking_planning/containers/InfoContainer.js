...
class Section extends Component {
    ...
    //     this.props.dispatch({type:'SET_FIELD',name:'rlistingId',value:selectedOption.value});
    //   };
                ...
                if (profile.typeId == 1114) {
                    ...
                    marriageForMap.forEach(function (marria, kMarria) {
                        childs.forEach(function (chi, kChi) {
                            ...
                            // if(marria.typeId == chi.typeId){
                            //     marriageForMap[kMarria] = chi;
                            //     console.log("có vô");
                            //     console.log(chi.typeId);
                            // }
                        })
                    })
