            ...
            return <div key={doc.key}>
                    <div className="row">
                        ...
                        <div style={{width:'50%'}} className="form-group col-md-6">
                            ...
                            <NumberFormat suffix="đ" thousandSeparator={true} type="text" name="income" onChange={(e) => {
                    ...
                    <div className="modal-dialog">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-group">
                                <span className="text-muted">Số tiền khách hàng có sẵn: <span className="text-danger">*</span></span>
                                <NumberFormat suffix="đ" thousandSeparator={true} type="text" name="initCapital" value={this.state.dataPost.initCapital} onChange={this.handleOnchange} className="form-control"/>
                            </div>
                            <div className="form-group">
                                <span className="text-muted">Số tiền khách hàng muốn vay: <span className="text-danger">*</span></span>
                                <NumberFormat suffix="đ" thousandSeparator={true} type="text" name="loan" value={this.state.dataPost.loan} onChange={this.handleOnchange} className="form-control" />
                            ...
                            <div>
                                ...
                                <div className="form-group">
                                    ...
                                    <NumberFormat suffix="đ" thousandSeparator={true} type="text" name="latestAmount" value={this.state.dataPost.latestAmount} onChange={this.handleOnchange} className="form-control" />
